import {Modal, Form, OverlayTrigger,
    Tooltip, Button, Col, Row, InputGroup} from 'react-bootstrap'
...
const CreateIdeaModal = ({formErrors, form, onImageDrop, clearImage,getInputProps, getRootProps, handleTagsChange, setPurpose, 
    handleChange,priceRef, setFormData, checkValidationBeforeSubmit, publishState, publishError, billet, ...props}) => {
    ...
    const getThumbnailImage = () => {
        return (
            form.thumbnail ? (
                ...
                >
                <Button className="remove-thumbnail-btn" variant="outline-secondary" onClick={() => {
                clearImage();
              }}>
                  ...
                  >
                    {({ getRootProps, getInputProps }) => (
                      <section className="container h-100 ">
                        ...
                        >
                          <input {...getInputProps()} />
                          <img src={imagePlaceholder} className="placeholder-image" alt=" placehoder" />
                          <p className="dropfile-text">
          ...
          >
            ...
            <div className="tags-section">
                ...
                >
                  ...
                  {CONSTANTS.STORAGE_TYPE.map((item) => (
                    <Form.Check
                      ...
                      onChange={() =>  setFormData({ ...form, storage: item.value })}
                      disabled
                      label={item.label}
                    />
                  ))}
               ...
               <Row className="button-section  d-flex">
                ...
                <Button  className="submit-btn" onClick={checkValidationBeforeSubmit}>
                    Submit
                </Button>
                </Col>
                </Row>
